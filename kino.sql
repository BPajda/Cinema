...
--
-- Host: 127.0.0.1
-- Czas generowania: 23 Cze 2022, 15:53
...
--
-- Struktura tabeli dla tabeli `chairs`
--
...
CREATE TABLE `movies` (
  `id` int(11) NOT NULL,
  `film` varchar(255) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `seans` (
  ...
  `day` varchar(20) COLLATE utf8_polish_ci NOT NULL,
  `hour` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(1, 2, 'niedziela', '21:37:00'),
(2, 3, 'środa', '13:30:00'),
(4, 4, 'czwartek', '16:00:00'),
(5, 1, 'piątek', '17:00:00'),
(6, 3, 'poniedziałek', '19:00:00'),
(7, 5, 'sobota', '15:30:00');
...
(4, 'maniek', '1937f167ce4a58749368ca8e815336da', 111111111, 0),
...
--
-- AUTO_INCREMENT dla tabeli `chairs`
--
ALTER TABLE `chairs`
